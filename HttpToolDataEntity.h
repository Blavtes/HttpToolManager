...
/** 请求实体， 承载请求参数**/
@interface HttpToolDataEntity : NSObject
/** 请求路径 */
...
@interface HttpToolFileDataEntity : HttpToolDataEntity
...
@interface HttpToolImageDataEntity : HttpToolDataEntity
